...
int main(void)
{
  char msg[] = "Lorem ipsum dolor sit amet, consectetur adipiscing elit. " \
		  	       "Aenean sed sapien diam. Duis eu leo sed est efficitur vestibulum" \
			         "a sit amet leo. Integer non neque nec libero cursus bibendum. " \
			         "Curabitur sed sapien sed felis porttitor ultrices at vel ligula" \
			         "blandit.";
